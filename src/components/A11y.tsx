...
export function SkipLink() {
  return (
    <a
      href="#main-content"
      className="sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 focus:z-[999] focus:px-4 focus:py-2 focus:bg-cy-navy focus:text-white focus:rounded-lg focus:font-bold focus:text-sm"
    >
      본문으로 건너뛰기
    </a>
  );
