...
export default function Tooltip({ text, children, position = "top" }: Props) {
  ...
  return (
    ...
    >
      {children}
      {show && (
        <span className={`absolute z-[100] px-3 py-2 bg-cy-ink text-white text-xs font-medium rounded-lg shadow-lg whitespace-nowrap animate-fade-in pointer-events-none max-w-[200px] text-center ${
