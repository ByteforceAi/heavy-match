...
export default function HeritageSection() {
  return (
    <section
      id="heritage"
      className="py-20 md:py-24 bg-cy-bg"
      ...
      <div className="max-w-[1400px] mx-auto px-6 md:px-12 grid lg:grid-cols-[1fr_1.2fr] gap-10 lg:gap-16 items-center">
        ...
        <div>
          ...
          <motion.h2
            ...
            className="text-[28px] md:text-[32px] font-[800] text-cy-ink leading-[1.3] tracking-[-0.02em] mb-5"
          >
            1998년, <span className="text-cy-navy">부산 중장비 업계의 기록.</span>
          </motion.h2>
          ...
          <div className="space-y-3">
            {heritageFull.paragraphs.map((p, i) => (
              <motion.p
                ...
                className="text-[14px] md:text-[15px] text-cy-ink-2 leading-[1.75]"
              >
                {p}
              </motion.p>
            ))}
          ...
          <motion.p
            ...
            className="text-[12px] text-cy-ink-3 mt-5 pt-4 border-t border-cy-line"
          >
          ...
          >
            <a
              href="/story"
              className="inline-flex items-center gap-1.5 text-[13px] font-bold text-cy-navy hover:text-cy-navy-mid transition-colors"
            >
              철연 이야기 전문 읽기
            ...
            <a
              ...
              className="inline-flex items-center gap-1.5 text-[12px] font-medium text-cy-ink-3 hover:text-cy-navy transition-colors"
            >
              부산일보 1998.02.24 원문
              <span aria-hidden="true">↗</span>
            </a>
        ...
        <motion.article
          ...
          className="relative bg-white border border-cy-line rounded-xl p-7 md:p-8"
          style={{
        ...
        >
          {/* 釜山日報 워터마크 */}
          <span
            className="absolute top-4 right-5 text-[11px] text-cy-ink-4"
          ...
          {/* 날짜 캡션 */}
          <p
            className="text-[11px] text-cy-ink-3 mb-3"
            style={{ fontFamily: "var(--font-roboto-mono), monospace" }}
          >
          ...
          <h3
            className="inline-block text-[18px] md:text-[20px] font-bold text-cy-ink pb-2 mb-2"
            style={{ borderBottom: "2px solid #0A1628" }}
          >
            {busanIlbo.headline}
          </h3>

          <p className="text-[12px] md:text-[13px] text-cy-ink-2 mb-4 mt-2">
            {busanIlbo.subhead}
          </p>

          {/* 본문 — 나철연 이름에 형광펜 하이라이트 */}
          <p
            className="text-[13px] md:text-[14px] text-cy-ink-2"
