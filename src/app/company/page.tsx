  ...
  return (
    ...
    >
      <div className="max-w-[1280px] mx-auto px-6 md:px-12 py-20 md:py-28">
        ...
        <Reveal delay={0.1}>
          <h1
            className="font-[900] text-cy-ink mb-5 max-w-[900px]"
            style={{
          ...
          >
            ...
            <span className="text-cy-navy">응답하는 회사다</span>
          </h1>
        </Reveal>

        <Reveal delay={0.2}>
          <p
            className="text-[16px] md:text-[18px] text-cy-ink-2 leading-[1.75] max-w-[720px] mb-10"
            style={{
        ...
        <Reveal delay={0.3}>
          ...
          >
            {pills.map((pill) => (
              <div
                key={pill.label}
                className="inline-flex items-center gap-2 px-4 py-2 bg-white border border-cy-line rounded-full"
              >
                <span className="text-[10px] text-cy-ink-3 tracking-[0.15em] uppercase">
                  {pill.label}
                </span>
                <span className="text-[13px] font-bold text-cy-ink tracking-[-0.01em]">
                  {pill.value}
                </span>
              </div>
            ))}
  ...
  return (
    <section className={`${SECTION_BASE} border-b border-cy-line`}>
      <Reveal>
        ...
        <h2
          className="text-[28px] md:text-[40px] font-[800] text-cy-ink tracking-[-0.025em] mb-12"
      ...
      <div className="max-w-[820px] space-y-6 mb-10">
        {paragraphs.map((p, i) => (
          <Reveal key={i} delay={0.05 + i * 0.08}>
            <p
              className="text-[16px] md:text-[17px] text-cy-ink"
              style={{
                fontFamily: "'IBM Plex Sans KR', Pretendard, serif",
                lineHeight: 1.9,
                letterSpacing: "-0.015em",
      ...
      <Reveal delay={0.4}>
        <Link
          href="/story"
          className="inline-flex items-center gap-3 max-w-[820px] w-full px-6 py-5 bg-white border border-cy-line rounded-2xl hover:border-cy-navy transition-colors group"
          style={{ boxShadow: CARD_SHADOW }}
        >
          <div className="flex-1">
            <p
              className="text-[11px] font-bold text-cy-navy tracking-[0.2em] mb-1"
              style={{ fontFamily: "var(--font-roboto-mono), monospace" }}
            >
              HERITAGE · L3
            </p>
            ...
            <p className="text-[12px] text-cy-ink-3 mt-0.5">
              1998년 부산일보 기사 재현 · §2.1 전문
            </p>
          </div>
          <span
            className="text-cy-navy text-[20px] group-hover:translate-x-1 transition-transform"
            aria-hidden="true"
          >
            →
          </span>
    ...
    <section className={`${SECTION_BASE} bg-white border-b border-cy-line`}>
      ...
      <div className="grid md:grid-cols-[400px_1fr] gap-10 md:gap-14 items-start">
        ...
        <div>
          <Reveal delay={0.15}>
            <h3
              className="text-[28px] md:text-[32px] font-[900] text-cy-ink tracking-[-0.03em]"
              style={{ lineHeight: 1.2 }}
            >
              이한결
            </h3>
            <p
              className="text-[13px] text-cy-ink-3 mt-1 mb-6 tracking-[0.05em]"
              style={{ fontFamily: "var(--font-roboto-mono), monospace" }}
            >
              Lee Han-gyeol
            </p>
            <p className="text-[14px] text-cy-navy font-semibold mb-8">
            ...
            <div className="flex flex-wrap gap-2.5">
              {links.map((link) => (
                <a
                  ...
                  className="inline-flex items-center gap-2 px-4 py-2 text-[13px] font-semibold text-cy-ink bg-white border border-cy-line rounded-lg hover:border-cy-navy hover:text-cy-navy transition-colors"
                >
                  <span>{link.label}</span>
                  {link.text && (
                    <span
                      className="text-[12px] text-cy-ink-3 font-medium"
                      style={{
                  ...
                  <span className="text-cy-ink-3" aria-hidden="true">
                    ↗
                  </span>
                </a>
              ))}
            ...
            <MotionCard className="p-8 h-full">
              <div className="flex items-center gap-3 mb-5">
                <span
                  ...
                  aria-hidden="true"
                />
                <h3 className="text-[22px] font-[900] text-cy-ink tracking-[-0.02em]">
                  {v.title}
                </h3>
              </div>
              <p
                className="text-[15px] text-cy-ink-2"
                style={{
                  fontFamily: "'IBM Plex Sans KR', Pretendard, serif",
                  lineHeight: 1.8,
                  letterSpacing: "-0.015em",
  ...
  return (
    <section className={`${SECTION_BASE} bg-white border-b border-cy-line`}>
      ...
      <div className="relative max-w-[960px]">
        <div
          aria-hidden="true"
          className="absolute left-[19px] md:left-[23px] top-2 bottom-2 w-[2px] bg-gradient-to-b from-cy-navy via-cy-line to-cy-cyan"
        />
          ...
          {entries.map((e, i) => (
            <Reveal key={e.period + e.title} delay={i * 0.08}>
              <div className="relative pl-14 md:pl-16">
                ...
                />
                <p
                  className="text-[13px] font-bold text-cy-navy tracking-[0.1em] mb-1.5"
                  style={{ fontFamily: "var(--font-roboto-mono), monospace" }}
                >
                  {e.period}
                </p>
                <h3
                  className="text-[18px] md:text-[20px] font-[800] text-cy-ink mb-2"
                  style={{ letterSpacing: "-0.02em" }}
                >
                  {e.title}
                </h3>
                <p
                  className="text-[14px] md:text-[15px] text-cy-ink-2 max-w-[720px]"
                  style={{
                    fontFamily: "'IBM Plex Sans KR', Pretendard, serif",
                    lineHeight: 1.75,
                    letterSpacing: "-0.015em",
    ...
    <section className={SECTION_BASE}>
      ...
      <Reveal delay={0.1}>
        ...
        >
          ...
          >
            <div>
              <p className="text-[10px] text-cy-ink-4 tracking-[0.2em] uppercase mb-1">
                Address
              </p>
              <p className="text-[14px] text-cy-ink font-medium">
                {business.address}
              </p>
            </div>
            <div>
              ...
              <a
                ...
                className="text-[14px] text-cy-navy font-medium hover:text-cy-navy-mid transition-colors"
              >
                {business.email}
              </a>
            </div>
          ...
          <div className="pt-6 border-t border-cy-line flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <p className="text-[13px] text-cy-ink-2">문의 및 제휴 접수처</p>
            <a
              href={`mailto:${business.email}`}
